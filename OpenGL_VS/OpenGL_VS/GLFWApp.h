...
public:
	...
	GLFWApp(int argc, char* argv[], const char* windowTitle, int windowSize_X, int windowSize_Y, int major = 2, int minor = 1,
		std::tuple<int, int> const & position = std::make_tuple(100, 100)) : _window(nullptr), _windowTitle(windowTitle), _major(major),
		_minor(minor), _mouseButtonFlags(0) {
